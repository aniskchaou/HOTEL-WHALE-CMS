...
if (! class_exists ( 'DTCoreCustomPostTypes' )) {
	...
	class DTCoreCustomPostTypes {
		...
		function __construct() {
			...
			if (!is_plugin_active('designthemes-portfolio-addon/designthemes-portfolio-addon.php') && !is_plugin_active_for_network('designthemes-portfolio-addon/designthemes-portfolio-addon.php')) {
