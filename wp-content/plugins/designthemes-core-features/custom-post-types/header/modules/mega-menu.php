        ...
        # Sub Menu Tab
            ...
            # Default State       
                ...
                array(
                    ...
                    'group' => esc_html__( 'Sub Menu', 'designthemes-core' ),
                    'value' => array(
                        esc_html__('Dashed','diaz') => "dashed",
                        esc_html__('Dotted','diaz') => "dotted",
                        esc_html__('Double','diaz') => "double",
                        esc_html__('Groove','diaz') => "groove",
                        esc_html__('None','diaz') => "none",
                        esc_html__('Ridge','diaz') => "ridge",
                        esc_html__('Solid','diaz') => "solid",
                    ),
