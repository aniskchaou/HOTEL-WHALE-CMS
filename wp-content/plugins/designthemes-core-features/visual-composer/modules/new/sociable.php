        	...
        	'heading' => esc_html__( 'Socials', 'designthemes-core' ),
  			...
  			'params' => array(
  				array(
  					...
  					'param_name' => 'social',
  					'value' => array(
						esc_html__('Delicious', 'diaz')	 	 => 'delicious',
						esc_html__('Deviantart', 'diaz')	 => 'deviantart',
						esc_html__('Digg', 'diaz')	 		 => 'digg',
						esc_html__('Dribbble', 'diaz')	 	 => 'dribbble',
						esc_html__('Envelope', 'diaz')	 	 => 'envelope',
						esc_html__('Facebook', 'diaz')	 	 => 'facebook',
						esc_html__('Flickr', 'diaz')	 	 => 'flickr',
						esc_html__('Google Plus', 'diaz') 	 => 'google-plus',
						esc_html__('Instagram', 'diaz')	 	 => 'instagram',
						esc_html__('Lastfm', 'diaz')	 	 => 'lastfm',
						esc_html__('Linkedin', 'diaz')	 	 => 'linkedin',
						esc_html__('Myspace', 'diaz')	 	 => 'myspace',
						esc_html__('Picasa', 'diaz')	 	 => 'picasa',
						esc_html__('Pinterest', 'diaz')	 	 => 'pinterest',
						esc_html__('Reddit', 'diaz')	 	 => 'reddit',
						esc_html__('RSS', 'diaz')	 		 => 'rss',
						esc_html__('Skype', 'diaz')	 		 => 'skype',
						esc_html__('Stumbleupon', 'diaz')	 => 'stumbleupon',
						esc_html__('Tumblr', 'diaz')	 	 => 'tumblr',
						esc_html__('Twitter', 'diaz')	 	 => 'twitter',
						esc_html__('Viadeo', 'diaz')	 	 => 'viadeo',
						esc_html__('Vimeo', 'diaz')	 	 	 => 'vimeo',
						esc_html__('Yahoo', 'diaz')	 		 => 'yahoo',
						esc_html__('Youtube', 'diaz')	 	 => 'youtube',
  					),
