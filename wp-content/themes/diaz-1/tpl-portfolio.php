    ...
    <div class="container"><?php
        ...
        <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
            ...
            # Filter Option
                ...
                if( (sizeof($categories) > 1) && ($settings['filter'] == 'true') ) :
                    ...
                    <div class="dt-sc-portfolio-sorting <?php echo esc_attr($post_style);?>">
                        <a href="#" class="active-sort" title="" data-filter=".all-sort"><?php esc_html_e('All','diaz');?></a>
                                    ...
                                    <div class="image-overlay">
                                        ...
                                        <?php elseif( $post_style == "type1" || $post_style == "type2" || $post_style == "type5" || $post_style == "type7" || $post_style == "type8"):?>
                                            ...
                                            <div class="image-overlay-details">
                                                <h2><a href="<?php the_permalink();?>" title="<?php printf( esc_attr__('Permalink to %s','diaz'), the_title_attribute('echo=0'));?>"><?php 
                                                    the_title();?></a></h2><?php
                                                if( $post_style != "type2"):
                                                    if( $post_style == "type7" ):
            ...
            <div class="pagination blog-pagination">
                <?php echo diaz_pagination($the_query); ?>
            </div><!-- **Pagination** --> 
